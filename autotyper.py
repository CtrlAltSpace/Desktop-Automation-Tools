...
print("⚠️  Warning, use this under your own risk. Self-botting and spamming may break the ToS. This program may be uncontrollable. Quickly move your mouse to any of the corner of the screen in case the Esc key fails.")
text = input("Enter the text to spam (Use | for line break): ")
parts = re.split(r"\s*\|\s*", text)
time_interval = float(input("Enter the time interval between the text in seconds (Very fast intervals may break your PC or the app.): "))
print("Do you want to do double enter? (Useful for autocompletion)")
yes_no = input('Type "yes" to do double enter: ').lower()
if yes_no == "yes":
    double_enter = True
else:
    double_enter = False
